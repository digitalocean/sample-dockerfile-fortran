...
After forking the repo, you should now be viewing this README in your own github org (e.g. `https://github.com/<your-org>/sample-dockerfile-fortran`)

## Deploying the App ##

Click this button to deploy the app to the DigitalOcean App Platform.

 [![Deploy to DO](https://mp-assets1.sfo2.digitaloceanspaces.com/deploy-to-do/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/digitalocean/sample-dockerfile-fortran/tree/main)
...
1. Edit [HelloWorld.f08](HelloWorld.f08)
...
1. Visit https://cloud.digitalocean.com/apps and navigate to your sample-dockerfile-fortran app.
...
1. Navigate to the sample-dockerfile-fortran app
